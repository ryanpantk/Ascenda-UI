    ...
    return (
        <div style={myStyle}>
            <div style={{marginLeft:'5%'}}>
                ...
                <a onclick="window.localStorage.setItem('path','/make-booking')" href="/make-booking">
                    <Button style={buttonStyle1}>
                        Get Started Now
                    </Button>      
                </a>     
                <a onclick="window.localStorage.setItem('path','/delete-booking')" href="/delete-booking"  /* style={{fontSize: '16px', marginLeft:'16px', color:'#FFFFFF'}} */>
