...
import { Image, Col, Result } from 'antd';
...
class HotelDisplay extends React.Component{
    ...
    sethotelListSlice=async(page)=>{
            await HotelPerPage(paginate(this.state.hotellist, page, this.state.pageSize)).then(data=>this.setState({hotelListSlice:data}))
         };
    ...
    render(){
        ...
        console.log(this.state.hotelListSlice);
            ...
            <table className='table'>
                ...
                <tbody>
                    ...
                    <tr key={hotel.id}>
                        ...
                        <td>{<h5> {hotel.lowest_converted_price} </h5>}</td>
                        <td><button onClick={()=>this.handleSelect(hotel)} type="button" class="btn btn-primary" id="selbtn">Select</button></td>
                    </tr>
                    )}
