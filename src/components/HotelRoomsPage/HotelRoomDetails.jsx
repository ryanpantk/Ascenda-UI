...
const GetHotelDetails = async (hotelID) => {
    let res = await fetch(`https://breakable-ray-panama-hat.cyclic.app/apis/hotelDetail/${hotelID}`);
...
const GetRoomDetails = async (hotelID) => {
    ...
    const res = await fetch("https://breakable-ray-panama-hat.cyclic.app/apis/hotelPrice", {
        method: 'POST',
